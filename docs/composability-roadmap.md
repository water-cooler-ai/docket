...
stale, duplicate, and superseded results cannot advance the run, and replay
plus external-effect idempotency rules are unchanged for late or rejected
results. See `Docket.Node`,

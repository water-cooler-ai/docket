...
- **DCKT-76 query plans** (`bench/postgres/dckt_76_query_plans.exs`):
  deterministic schema-v3 candidate and reconciliation shape evidence. It
...
[TenantFair schema-v3 budgets and query shapes](architecture/docket-tenant-fair-schema-v3.md).

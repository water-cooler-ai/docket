...
Backend startup persists its configured default before children start, then it
...
accounting while treating the persisted policy as live authority. Its complete contract is the

defmodule Docket.Checkpoint.Observer do
  ...
  Production observers are configured with `checkpoint_observers:`. An
  observer runs only after a backend transaction commits and can never roll
  durable state back.
  Delivery runs asynchronously under the
